...
public class ClientService extends WebServiceGatewaySupport {
    ...
    public com.parameta.springboot.backend.apirest.models.entity.Employee saveEmployee(Object employee) throws Exception {

        Insert request = new Insert();
        request.setEmployee(buildEmployee((com.parameta.springboot.backend.apirest.models.entity.Employee) employee));
        ...
        com.parameta.springboot.backend.apirest.models.entity.Employee empl = buildJson(response.getValue(), (com.parameta.springboot.backend.apirest.models.entity.Employee) employee);

        return empl;

    }

    private Employee buildEmployee(com.parameta.springboot.backend.apirest.models.entity.Employee employee) {
    ...
    private com.parameta.springboot.backend.apirest.models.entity.Employee buildJson(InsertResponse insertResponse, com.parameta.springboot.backend.apirest.models.entity.Employee employee) throws Exception {
